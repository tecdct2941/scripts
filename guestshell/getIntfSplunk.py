...
#
# This script writes interface data to a file in json format which can
# be picked up by a Splunk forwarder.
...
outter = "{ \"interface\": \"" + name + "\", \"packets_in\": \"" + str(pkts_in)
outter += "\", \"bytes_in\": \"" + str(bytes_in) + "\", \"packets_out\": \""
outter += str(pkts_out) + "\", \"bytes_out\": \"" + str(bytes_out) + "\" }"
